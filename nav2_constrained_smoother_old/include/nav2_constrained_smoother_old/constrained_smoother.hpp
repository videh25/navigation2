...
#include "nav2_constrained_smoother_old/smoother.hpp"
...
/**
 * @class nav2_constrained_smoother_old::ConstrainedSmootherOld
 * @brief Regulated pure pursuit controller plugin
 */
class ConstrainedSmootherOld : public nav2_core::Smoother
{
public:
  /**
   * @brief Constructor for nav2_constrained_smoother_old::ConstrainedSmootherOld
   */
  ConstrainedSmootherOld() = default;

  /**
   * @brief Destrructor for nav2_constrained_smoother_old::ConstrainedSmootherOld
   */
  ~ConstrainedSmootherOld() override = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("ConstrainedSmootherOld")};

  std::unique_ptr<nav2_constrained_smoother_old::Smoother> smoother_;
