...
#include "nav2_constrained_smoother_old/options.hpp"
...
/**
 * @struct nav2_constrained_smoother_old::SmootherCostFunction
...
public:
  /**
   * @brief A constructor for nav2_constrained_smoother_old::SmootherCostFunction
