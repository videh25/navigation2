...
protected:
  ...
  {
    node_lifecycle_ =
      std::make_shared<nav2::LifecycleNode>("ConstrainedSmootherOldTestNode");
    ...
    smoother_ = std::make_shared<nav2_constrained_smoother_old::ConstrainedSmootherOld>();
  ...
  std::shared_ptr<nav2_constrained_smoother_old::ConstrainedSmootherOld> smoother_;
